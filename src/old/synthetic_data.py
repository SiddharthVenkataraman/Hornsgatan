...
real_df.to_csv('data/synthetic/real_data_{detector}.csv', index=False)
...
for _ in range(num_vehicles):
    ...
    rows.append({
        'synthetic_time': next_time,
        'syntetic_speed': next_speed,
    })
...
synth_time = synthetic_df['synthetic_time']
synth_speed = synthetic_df['syntetic_speed']
...
plt.tight_layout()
# Save histogram plot
plt.savefig('data/synthetic/compare_hist.png')
# Display the plot
plt.show()
...
plt.savefig('data/synthetic/compare_timeseries.png')
# Display the plot
plt.show()
